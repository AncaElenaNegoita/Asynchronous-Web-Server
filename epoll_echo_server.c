...
/* The global variables, the connection state enum and the connection struct are now
* declared in epoll_echo_server.h, adding another fields that are needed in the program.*/
